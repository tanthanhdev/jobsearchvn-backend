...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('employers', '0002_auto_20220315_1530'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='employer_job', to='employers.Employer')),
                ('job_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='job_type_job', to='jobs.JobType')),
